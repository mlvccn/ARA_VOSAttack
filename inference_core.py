...
class InferenceCore:
    def __init__(self, prop_net:STCN, images, num_objects, top_k=20, mem_every=5, include_last=False):
        ...
        # print('inference core:',images.requires_grad)
        # Padded dimensions
        nh, nw = images.shape[-2:]

        self.images = images
        # print('self.image:',self.images.requires_grad)
        self.device = 'cuda'
    ...
    def do_pass(self, key_k, key_v, idx, end_idx,attack=False):
        ...
        for ti in this_range:
            ...
            out_mask = self.prop_net.segment_with_query(self.mem_bank, qf8, qf4, k16, qv16,attack=attack)
    ...
    def interact(self, mask, frame_idx, end_idx, attack=False):
